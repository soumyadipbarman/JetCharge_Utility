...
//Check the folder for all Monte carlo file for plots
 TH1F *MC_hist[30][26];  //maximum number of Monte carlo can be analysis in 30
...
Int_t outnum =0;
       ...
       {                                                     //Start the loop using output number
         ...
         if  (line[0] != '\0') {
           ...
           for(int ivar=0; ivar < numplot ; ivar ++){
             if(ivar==0){sprintf(histname2, "JetCharge_2017/h_ngoodrecojet");};
             if(ivar==1){sprintf(histname2, "JetCharge_2017/h_goodrecojetpt");};
             if(ivar==2){sprintf(histname2, "JetCharge_2017/h_goodrecojeteta");};
             if(ivar==3){sprintf(histname2, "JetCharge_2017/h_goodrecojetphi");};
             if(ivar==4){sprintf(histname2, "JetCharge_2017/h_goodrecojetpt1");};
             if(ivar==5){sprintf(histname2, "JetCharge_2017/h_goodrecojeteta1");};
             if(ivar==6){sprintf(histname2, "JetCharge_2017/h_goodrecojetphi1");};
	     if(ivar==7){sprintf(histname2, "JetCharge_2017/h_goodrecojetpt2");};
             if(ivar==8){sprintf(histname2, "JetCharge_2017/h_goodrecojeteta2");};
             if(ivar==9){sprintf(histname2, "JetCharge_2017/h_goodrecojetphi2");};
	     if(ivar==10){sprintf(histname2, "JetCharge_2017/h_nrecoChgCands");};
             if(ivar==11){sprintf(histname2, "JetCharge_2017/h_jetchgpt");};
             if(ivar==12){sprintf(histname2, "JetCharge_2017/h_jetchgeta");};
	     if(ivar==13){sprintf(histname2, "JetCharge_2017/h_jetchgphi");};
             if(ivar==14){sprintf(histname2, "JetCharge_2017/h_nrecoChgCands1");};
             if(ivar==15){sprintf(histname2, "JetCharge_2017/h_jetchgpt1");};
             if(ivar==16){sprintf(histname2, "JetCharge_2017/h_jetchgeta1");};
             if(ivar==17){sprintf(histname2, "JetCharge_2017/h_jetchgphi1");};
             if(ivar==18){sprintf(histname2, "JetCharge_2017/h_nrecoChgCands2");};
             if(ivar==19){sprintf(histname2, "JetCharge_2017/h_jetchgpt2");};
             if(ivar==20){sprintf(histname2, "JetCharge_2017/h_jetchgeta2");};
             if(ivar==21){sprintf(histname2, "JetCharge_2017/h_jetchgphi2");};
             if(ivar==22){sprintf(histname2, "JetCharge_2017/h_nrecoCands1");};
             if(ivar==23){sprintf(histname2, "JetCharge_2017/h_nrecoCands2");};
             if(ivar==24){sprintf(histname2, "JetCharge_2017/h_jetcharge1");};
             if(ivar==25){sprintf(histname2, "JetCharge_2017/h_jetcharge2");};
 ...
 TFile *file1 = TFile::Open("JetCharge_skimmer-histOut_DATA.root");  // data root file
 ...
 for(int ivar=0; ivar < numplot ; ivar ++){
	     if(ivar==0){sprintf(histname1, "JetCharge_2017/h_ngoodrecojet");};
...
//const char* varlogx[26] ={"Pt of leading jet (GeV/c)", "Pt of second leading jet (GeV/c)","H_{T2} (GeV/c)","#Delta Pt of two leading jets (GeV/c)","Pt2 x sin( #Delta #phi )/Pt1","#eta of leading jet", "#eta of second leading jet", "#phi of leading jet","#Delta#phi of Jets","No. of jet","No. of Charged particles"};
 ...
 const char* varlogy[26] ={"1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d","1/N dN/d"};
 ...
 for(int ivar=0; ivar < 26 ; ivar ++){ // loop for variables
  ...
  }else if(ivar==25) {cpt0->Print("JetCharge_Basic_dist.pdf)","pdf");
  }else{
